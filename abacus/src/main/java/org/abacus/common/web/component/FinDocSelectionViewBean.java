...
public class FinDocSelectionViewBean implements Serializable {
	...
	public List<FinDocumentEntity> getDocumentList(EnumList.DefTypeEnum typeEnum) {
		...
		if (resultMap.containsKey(key)) {
			...
			ReadDocumentEvent<FinDocumentEntity> readDocumentEvent = finTransactionHandler.readDocumentList(new RequestReadDocumentEvent<FinDocumentEntity>(documentSearchCriteria, sessionInfoHelper.currentOrganizationId(), sessionInfoHelper.selectedFiscalYearId()));
