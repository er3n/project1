...
public class FinReportDao implements Serializable {
	...
	public List<FinDetailEntity> getFinState(ReportSearchCriteria reportSearchCriteria) {
		...
		sb.append("select {item.*}, {department.*}, v.baseDetailAmount ");
		sb.append("  from org_department department, def_item item,");
		sb.append("     (select d.item_id, d.department_id, sum(d.base_detail_amount*d.tr_state_detail) baseDetailAmount ");
