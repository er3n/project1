...
@ManagedBean
@ViewScoped
public class QueryFinStateViewBean implements Serializable {
	...
	public void searchResult() {
		...
		ReadReportEvent<FinDetailEntity> readReportEvent = reportHandler.getFinState(requestReadReportEvent);
