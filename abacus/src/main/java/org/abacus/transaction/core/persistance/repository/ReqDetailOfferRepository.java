...
public interface ReqDetailOfferRepository extends CrudRepository<ReqDetailOfferEntity, Long> {
	...
	@Query("select o from ReqDetailOfferEntity o inner join fetch o.detail d left outer join fetch d.stkDocument s where d.document.id = :documentId and o.isSelected = true")
