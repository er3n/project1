...
insert into budget_document(id,version,fiscal_year_id,estimate_date, budget_note) values (nextval('seq_id'),0,'#.#1.#1:'||trim(to_char(currval('seq_id')-4,'00000000')), DATE '2014-01-01','2014 #.#1.#1 butcesi')
insert into budget_detail(id,version,document_id,fiscal_period_id,budget_rx,budget_type,budget_amount) values (nextval('seq_id'),0,currval('seq_id') -1,'#.#1.#1:'||trim(to_char(currval('seq_id')-4- 1,'00000000'))||':01', 'BUD_R','ESTIMATE',510)
insert into budget_detail(id,version,document_id,fiscal_period_id,budget_rx,budget_type,budget_amount) values (nextval('seq_id'),0,currval('seq_id') -2,'#.#1.#1:'||trim(to_char(currval('seq_id')-4- 2,'00000000'))||':02', 'BUD_R','ESTIMATE',750)
insert into budget_detail(id,version,document_id,fiscal_period_id,budget_rx,budget_type,budget_amount) values (nextval('seq_id'),0,currval('seq_id') -3,'#.#1.#1:'||trim(to_char(currval('seq_id')-4- 3,'00000000'))||':03', 'BUD_R','ESTIMATE',620)
insert into budget_detail(id,version,document_id,fiscal_period_id,budget_rx,budget_type,budget_amount) values (nextval('seq_id'),0,currval('seq_id') -4,'#.#1.#1:'||trim(to_char(currval('seq_id')-4- 4,'00000000'))||':04', 'BUD_R','ESTIMATE',830)
insert into budget_detail(id,version,document_id,fiscal_period_id,budget_rx,budget_type,budget_amount) values (nextval('seq_id'),0,currval('seq_id') -5,'#.#1.#1:'||trim(to_char(currval('seq_id')-4- 5,'00000000'))||':05', 'BUD_R','ESTIMATE',660)
insert into budget_detail(id,version,document_id,fiscal_period_id,budget_rx,budget_type,budget_amount) values (nextval('seq_id'),0,currval('seq_id') -6,'#.#1.#1:'||trim(to_char(currval('seq_id')-4- 6,'00000000'))||':06', 'BUD_R','ESTIMATE',490)
insert into budget_detail(id,version,document_id,fiscal_period_id,budget_rx,budget_type,budget_amount) values (nextval('seq_id'),0,currval('seq_id') -7,'#.#1.#1:'||trim(to_char(currval('seq_id')-4- 7,'00000000'))||':07', 'BUD_R','ESTIMATE',700)
insert into budget_detail(id,version,document_id,fiscal_period_id,budget_rx,budget_type,budget_amount) values (nextval('seq_id'),0,currval('seq_id') -8,'#.#1.#1:'||trim(to_char(currval('seq_id')-4- 8,'00000000'))||':08', 'BUD_R','ESTIMATE',680)
insert into budget_detail(id,version,document_id,fiscal_period_id,budget_rx,budget_type,budget_amount) values (nextval('seq_id'),0,currval('seq_id') -9,'#.#1.#1:'||trim(to_char(currval('seq_id')-4- 9,'00000000'))||':09', 'BUD_R','ESTIMATE',870)
insert into budget_detail(id,version,document_id,fiscal_period_id,budget_rx,budget_type,budget_amount) values (nextval('seq_id'),0,currval('seq_id')-10,'#.#1.#1:'||trim(to_char(currval('seq_id')-4-10,'00000000'))||':10', 'BUD_R','ESTIMATE',300)
insert into budget_detail(id,version,document_id,fiscal_period_id,budget_rx,budget_type,budget_amount) values (nextval('seq_id'),0,currval('seq_id')-11,'#.#1.#1:'||trim(to_char(currval('seq_id')-4-11,'00000000'))||':11', 'BUD_R','ESTIMATE',460)
insert into budget_detail(id,version,document_id,fiscal_period_id,budget_rx,budget_type,budget_amount) values (nextval('seq_id'),0,currval('seq_id')-12,'#.#1.#1:'||trim(to_char(currval('seq_id')-4-12,'00000000'))||':12', 'BUD_R','ESTIMATE',450)

insert into budget_detail(id,version,document_id,fiscal_period_id,budget_rx,budget_type,budget_amount) values (nextval('seq_id'),0,currval('seq_id')-13,'#.#1.#1:'||trim(to_char(currval('seq_id')-16- 1,'00000000'))||':01', 'BUD_X','ESTIMATE',505)
insert into budget_detail(id,version,document_id,fiscal_period_id,budget_rx,budget_type,budget_amount) values (nextval('seq_id'),0,currval('seq_id')-14,'#.#1.#1:'||trim(to_char(currval('seq_id')-16- 2,'00000000'))||':02', 'BUD_X','ESTIMATE',760)
insert into budget_detail(id,version,document_id,fiscal_period_id,budget_rx,budget_type,budget_amount) values (nextval('seq_id'),0,currval('seq_id')-15,'#.#1.#1:'||trim(to_char(currval('seq_id')-16- 3,'00000000'))||':03', 'BUD_X','ESTIMATE',590)
insert into budget_detail(id,version,document_id,fiscal_period_id,budget_rx,budget_type,budget_amount) values (nextval('seq_id'),0,currval('seq_id')-16,'#.#1.#1:'||trim(to_char(currval('seq_id')-16- 4,'00000000'))||':04', 'BUD_X','ESTIMATE',800)
insert into budget_detail(id,version,document_id,fiscal_period_id,budget_rx,budget_type,budget_amount) values (nextval('seq_id'),0,currval('seq_id')-17,'#.#1.#1:'||trim(to_char(currval('seq_id')-16- 5,'00000000'))||':05', 'BUD_X','ESTIMATE',500)
insert into budget_detail(id,version,document_id,fiscal_period_id,budget_rx,budget_type,budget_amount) values (nextval('seq_id'),0,currval('seq_id')-18,'#.#1.#1:'||trim(to_char(currval('seq_id')-16- 6,'00000000'))||':06', 'BUD_X','ESTIMATE',450)
insert into budget_detail(id,version,document_id,fiscal_period_id,budget_rx,budget_type,budget_amount) values (nextval('seq_id'),0,currval('seq_id')-19,'#.#1.#1:'||trim(to_char(currval('seq_id')-16- 7,'00000000'))||':07', 'BUD_X','ESTIMATE',620)
insert into budget_detail(id,version,document_id,fiscal_period_id,budget_rx,budget_type,budget_amount) values (nextval('seq_id'),0,currval('seq_id')-20,'#.#1.#1:'||trim(to_char(currval('seq_id')-16- 8,'00000000'))||':08', 'BUD_X','ESTIMATE',600)
insert into budget_detail(id,version,document_id,fiscal_period_id,budget_rx,budget_type,budget_amount) values (nextval('seq_id'),0,currval('seq_id')-21,'#.#1.#1:'||trim(to_char(currval('seq_id')-16- 9,'00000000'))||':09', 'BUD_X','ESTIMATE',570)
insert into budget_detail(id,version,document_id,fiscal_period_id,budget_rx,budget_type,budget_amount) values (nextval('seq_id'),0,currval('seq_id')-22,'#.#1.#1:'||trim(to_char(currval('seq_id')-16-10,'00000000'))||':10', 'BUD_X','ESTIMATE',280)
insert into budget_detail(id,version,document_id,fiscal_period_id,budget_rx,budget_type,budget_amount) values (nextval('seq_id'),0,currval('seq_id')-23,'#.#1.#1:'||trim(to_char(currval('seq_id')-16-11,'00000000'))||':11', 'BUD_X','ESTIMATE',415)
insert into budget_detail(id,version,document_id,fiscal_period_id,budget_rx,budget_type,budget_amount) values (nextval('seq_id'),0,currval('seq_id')-24,'#.#1.#1:'||trim(to_char(currval('seq_id')-16-12,'00000000'))||':12', 'BUD_X','ESTIMATE',400)
commit;
