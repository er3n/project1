...
insert into org_organization (id, name, level_enum, parent_id) values ('0', 'SysHolding', 'L0', null);
insert into org_organization (id, name, level_enum, parent_id) values ('0.0', 'SysCompany', 'L1', '0');
insert into org_organization (id, name, level_enum, parent_id) values ('0.0.0', 'SysSection', 'L2', '0.0');
insert into org_organization (id, name, level_enum, parent_id) values ('0.0.0.0', 'SysProject', 'L3', '0.0.0');
...
insert into sec_group (id, name, version) values (nextval('seq_id'), 'AdminSys', 0);
...
insert into sec_user_organization (id, user_id, organization_id, version) values (nextval('seq_id'), 'admin','0', 0);
...
insert into def_type (id, name, group_enum, level, trtype) values ('SEHIR', 'Sehirler', 'V', 9, 0);
insert into def_type (id, name, group_enum, level, trtype) values ('TAT', 'Tat Tipleri', 'V', 1, 0);
insert into def_type (id, name, group_enum, level, trtype) values ('BESIN', 'Besin Tipleri', 'V', 1, 0);
...
insert into def_value (id, type_id, parent_id, code, name, is_active, version) values (nextval('seq_id'), 'TAT', 0, 'TA', 'Tatli', 1, 0);
insert into def_value (id, type_id, parent_id, code, name, is_active, version) values (nextval('seq_id'), 'TAT', 0, 'TU', 'Tuzlu', 1, 0);
insert into def_value (id, type_id, parent_id, code, name, is_active, version) values (nextval('seq_id'), 'TAT', 0, 'EK', 'Eksi', 1, 0);
insert into def_value (id, type_id, parent_id, code, name, is_active, version) values (nextval('seq_id'), 'TAT', 0, 'AC', 'Aci', 1, 0);

insert into def_value (id, type_id, parent_id, code, name, is_active, version) values (nextval('seq_id'), 'BESIN', 0, 'Y', 'Yag', 1, 0);
insert into def_value (id, type_id, parent_id, code, name, is_active, version) values (nextval('seq_id'), 'BESIN', 0, 'K', 'Karbonhidrat', 1, 0);
insert into def_value (id, type_id, parent_id, code, name, is_active, version) values (nextval('seq_id'), 'BESIN', 0, 'Y', 'Protein', 1, 0);


insert into def_value (id, type_id, parent_id, code, name, is_active, version) values (nextval('seq_id'), 'SEHIR', 0, '06', 'Ankara', 1, 0);
insert into def_value (id, type_id, parent_id, code, name, is_active, version) values (nextval('seq_id'), 'SEHIR', currval('seq_id')-1, '06.01', 'Cankaya', 1, 0);
...
insert into org_department (id, organization_id, group_enum, code, name, version) values (nextval('seq_id'), '0', 'A', 'Sys-H', 'Holding Yonetim',0);
insert into org_department (id, organization_id, group_enum, code, name, version) values (nextval('seq_id'), '0.0', 'A', 'Sys-C','Sirket Yonetim',0);
insert into org_department (id, organization_id, group_enum, code, name, version) values (nextval('seq_id'), '0.0.0', 'S', 'Sys-S','Bolge Depo',0);
insert into org_department (id, organization_id, group_enum, code, name, version) values (nextval('seq_id'), '0.0.0.0', 'S', 'Sys-P','Proje Depo',0);
...
insert into org_department (id, organization_id, group_enum, code, name, version) values (nextval('seq_id'), '01.01.01', 'S', '01-B','Bolge Depo',0);
insert into org_department (id, organization_id, group_enum, code, name, version) values (nextval('seq_id'), '01.01.01.01', 'S', '01-P','Project Depo',0);


insert into def_unit_group (id, organization_id, code, name, version) values (nextval('seq_id'), '0', 'S', 'Sayilabilen', 0);
...
insert into def_unit_group (id, organization_id, code, name, version) values (nextval('seq_id'), '0', 'A', 'Agirlik',0);
...
insert into def_unit_group (id, organization_id, code, name, version) values (nextval('seq_id'), '0', 'H', 'Hacim',0);
...
insert into def_unit_group (id, organization_id, code, name, version) values (nextval('seq_id'), '0', 'U', 'Uzunluk',0);
