...
create table cat_menu_info (id int8 not null, date_created timestamp, date_updated timestamp, user_created varchar(30), user_updated varchar(30), version int4 not null, count_prepare numeric(10, 0) not null, unit_price numeric(10, 2) not null, fiscal_year_id varchar(30) not null, meal_id int8 not null, primary key (id));
...
create table org_fiscal_period (id varchar(30) not null, date_finish date, date_start date, is_acc_active int4 not null, is_fin_active int4 not null, is_stk_active int4 not null, period_no int4 not null, fiscal_year_id varchar(30) not null, primary key (id));
create table org_fiscal_year (id varchar(30) not null, date_finish date, date_start date, name varchar(255) not null, customer_id int8, organization_id varchar(30) not null, primary key (id));
...
create table sec_authority (id varchar(30) not null, name varchar(255) not null, primary key (id));
...
create table sec_user (id varchar(30) not null, is_active int4 not null, password varchar(255) not null, vendor_id int8, primary key (id));
