...
insert into org_fiscal_year(id, organization_id, name, date_start, date_finish, profit_rate) VALUES ('##.#1:'||trim(to_char(nextval('seq_id'),'00000000')), '##.#1', 'FY.1:2014', DATE '2014-01-01', DATE '2014-12-31',0);
insert into org_fiscal_period(id, fiscal_year_id, period_no, date_start, date_finish, is_acc_active, is_fin_active, is_stk_active) VALUES ('##.#1:'||trim(to_char(currval('seq_id'),'00000000'))||':01', '##.#1:'||trim(to_char(currval('seq_id'),'00000000')), '01', DATE '2014-01-01', DATE '2014-04-30', 1, 1, 1);
insert into org_fiscal_period(id, fiscal_year_id, period_no, date_start, date_finish, is_acc_active, is_fin_active, is_stk_active) VALUES ('##.#1:'||trim(to_char(currval('seq_id'),'00000000'))||':02', '##.#1:'||trim(to_char(currval('seq_id'),'00000000')), '02', DATE '2014-05-01', DATE '2014-08-31', 1, 1, 1);
insert into org_fiscal_period(id, fiscal_year_id, period_no, date_start, date_finish, is_acc_active, is_fin_active, is_stk_active) VALUES ('##.#1:'||trim(to_char(currval('seq_id'),'00000000'))||':03', '##.#1:'||trim(to_char(currval('seq_id'),'00000000')), '03', DATE '2014-09-01', DATE '2014-12-31', 1, 1, 1);

insert into org_fiscal_year(id, organization_id, name, date_start, date_finish, profit_rate) VALUES ('##.#1.#1:'||trim(to_char(nextval('seq_id'),'00000000')), '##.#1.#1', 'Prj.1.1:2014', DATE '2014-01-01', DATE '2014-12-31',0);
insert into org_fiscal_period(id, fiscal_year_id, period_no, date_start, date_finish, is_acc_active, is_fin_active, is_stk_active) VALUES ('##.#1.#1:'||trim(to_char(currval('seq_id'),'00000000'))||':01', '##.#1.#1:'||trim(to_char(currval('seq_id'),'00000000')),'01', DATE '2014-01-01', DATE '2014-01-31', 1, 1, 1);
insert into org_fiscal_period(id, fiscal_year_id, period_no, date_start, date_finish, is_acc_active, is_fin_active, is_stk_active) VALUES ('##.#1.#1:'||trim(to_char(currval('seq_id'),'00000000'))||':02', '##.#1.#1:'||trim(to_char(currval('seq_id'),'00000000')),'02', DATE '2014-02-01', DATE '2014-02-28', 1, 1, 1);
insert into org_fiscal_period(id, fiscal_year_id, period_no, date_start, date_finish, is_acc_active, is_fin_active, is_stk_active) VALUES ('##.#1.#1:'||trim(to_char(currval('seq_id'),'00000000'))||':03', '##.#1.#1:'||trim(to_char(currval('seq_id'),'00000000')),'03', DATE '2014-03-01', DATE '2014-03-31', 1, 1, 1);
insert into org_fiscal_period(id, fiscal_year_id, period_no, date_start, date_finish, is_acc_active, is_fin_active, is_stk_active) VALUES ('##.#1.#1:'||trim(to_char(currval('seq_id'),'00000000'))||':04', '##.#1.#1:'||trim(to_char(currval('seq_id'),'00000000')),'04', DATE '2014-04-01', DATE '2014-04-30', 1, 1, 1);
insert into org_fiscal_period(id, fiscal_year_id, period_no, date_start, date_finish, is_acc_active, is_fin_active, is_stk_active) VALUES ('##.#1.#1:'||trim(to_char(currval('seq_id'),'00000000'))||':05', '##.#1.#1:'||trim(to_char(currval('seq_id'),'00000000')),'05', DATE '2014-05-01', DATE '2014-05-31', 1, 1, 1);
insert into org_fiscal_period(id, fiscal_year_id, period_no, date_start, date_finish, is_acc_active, is_fin_active, is_stk_active) VALUES ('##.#1.#1:'||trim(to_char(currval('seq_id'),'00000000'))||':06', '##.#1.#1:'||trim(to_char(currval('seq_id'),'00000000')),'06', DATE '2014-06-01', DATE '2014-06-30', 1, 1, 1);
insert into org_fiscal_period(id, fiscal_year_id, period_no, date_start, date_finish, is_acc_active, is_fin_active, is_stk_active) VALUES ('##.#1.#1:'||trim(to_char(currval('seq_id'),'00000000'))||':07', '##.#1.#1:'||trim(to_char(currval('seq_id'),'00000000')),'07', DATE '2014-07-01', DATE '2014-07-31', 1, 1, 1);
insert into org_fiscal_period(id, fiscal_year_id, period_no, date_start, date_finish, is_acc_active, is_fin_active, is_stk_active) VALUES ('##.#1.#1:'||trim(to_char(currval('seq_id'),'00000000'))||':08', '##.#1.#1:'||trim(to_char(currval('seq_id'),'00000000')),'08', DATE '2014-08-01', DATE '2014-08-31', 1, 1, 1);
insert into org_fiscal_period(id, fiscal_year_id, period_no, date_start, date_finish, is_acc_active, is_fin_active, is_stk_active) VALUES ('##.#1.#1:'||trim(to_char(currval('seq_id'),'00000000'))||':09', '##.#1.#1:'||trim(to_char(currval('seq_id'),'00000000')),'09', DATE '2014-09-01', DATE '2014-09-30', 1, 1, 1);
...
insert into cat_menu_info(id, version, fiscal_year_id, meal_id, count_prepare, count_total, unit_price) values (nextval('seq_id'), 0, '##.#1.#1:'||trim(to_char(currval('seq_id')-1,'00000000')), (select v.id from def_item v where v.type_id='ITM_SR_FN' and v.code='M1' and organization_id='##' and class_enum='FIN_R'), 150, 150000, 3.0);
insert into cat_menu_info(id, version, fiscal_year_id, meal_id, count_prepare, count_total, unit_price) values (nextval('seq_id'), 0, '##.#1.#1:'||trim(to_char(currval('seq_id')-2,'00000000')), (select v.id from def_item v where v.type_id='ITM_SR_FN' and v.code='M2' and organization_id='##' and class_enum='FIN_R'), 200, 200000, 5.0);
insert into cat_menu_info(id, version, fiscal_year_id, meal_id, count_prepare, count_total, unit_price) values (nextval('seq_id'), 0, '##.#1.#1:'||trim(to_char(currval('seq_id')-3,'00000000')), (select v.id from def_item v where v.type_id='ITM_SR_FN' and v.code='M3' and organization_id='##' and class_enum='FIN_R'), 175, 175000, 7.5);
...
insert into org_fiscal_year(id, organization_id, name, date_start, date_finish, profit_rate) VALUES ('##.#1.#2:'||trim(to_char(nextval('seq_id'),'00000000')), '##.#1.#2', 'Prj.1.2:2014', DATE '2014-01-01', DATE '2014-12-31',0);
...
insert into org_fiscal_year(id, organization_id, name, date_start, date_finish, profit_rate) VALUES ('##.#2:'||trim(to_char(nextval('seq_id'),'00000000')), '##.#2', 'FY.2:2014', DATE '2014-01-01', DATE '2014-12-31',0);
...
insert into org_fiscal_year(id, organization_id, name, date_start, date_finish, profit_rate) VALUES ('##.#2.#1:'||trim(to_char(nextval('seq_id'),'00000000')), '##.#2.#1', 'Prj.2.1:2014', DATE '2014-01-01', DATE '2014-12-31',0);
